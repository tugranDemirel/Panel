                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8 ml-auto mr-auto">
                                    ...
                                    <div class="form-group">
                                        <label>Başlık</label>
                                        <input style="color: black;" type="text" class="form-control" name="literaturetitle" id="literaturetitle" value="<?= $getLiterature['literature_title'] ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Konu</label>
                                        <textarea style="color: black;" class="form-control" name="literaturesubject" rows="5" readonly>
                                            <?= $getLiterature['literature_subject'] ?>
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>İçerik</label>
                                        <textarea style="color: black;" class="form-control ckeditor" name="literaturecontent" id="literaturecontent" readonly>
                                            <?= $getLiterature['literature_content'] ?>
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Anahtar Kelirmeler</label>
                                        <input style="color: black;" type="text" class="form-control" name="literaturekeywords" id="literaturekeywords" maxlength="160" value="<?= $getLiterature['literature_keywords'] ?>" readonly>
                        ...
                        <div class="card-action ">
                            <div class="col-md-2 ml-auto mr-auto">
                                <a href="category-literature.php" type="submit" name="literaturecancel" class="btn btn-icon btn-round btn-success mx-2">
