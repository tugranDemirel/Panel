<?php 
	...
	// database connection
	$auhtor = $conn->prepare("SELECT * FROM author WHERE author_category=:technology");
    $technology = $conn->prepare("SELECT * FROM technology");
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-8 ml-auto mr-auto">
													...
													<div class="form-group">
														<label >Başlık</label>
														<input style="color: white;" type="text" name="technologytitle" class="form-control"  id="technologytitle">
													</div>							
													<div class="form-group">
														<label >Konu</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label >İçerik</label>
                                                        <textarea style="color: white;" name="technologycontent" class="form-control ckeditor"  id="technologycontent">
                                                        </textarea>
                                                    </div>							
													<div class="form-group">
									...
									<div class="card-action ">
										<div class="col-md-2 ml-auto mr-auto">
											<button type="submit" name="technologyasave" class="btn btn-icon btn-round btn-success mx-2" data-original-title="Kaydet">
												<i class="fa fa-check"></i>
											</button>
											<button type="submit" name="technologycancel" class="btn btn-icon btn-round btn-danger mx-2" data-original-title="İptal">
